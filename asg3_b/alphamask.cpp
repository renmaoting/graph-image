...
void init(int argc, char* argv[])
{
    ...
    imageBuffer[0] = read->readImage(argv[1]);
    imageBuffer[1] = read->readImage(argv[2]);
    
    
    displayImageData = manipulation->verticalFlip(imageData);
    windowWidth =  imageBuffer[0]->width;
    windowHeight = imageBuffer[1]->height;
}
